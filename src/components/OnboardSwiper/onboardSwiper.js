/**
 * OnboardSwiper
 * Renders a swipeable set of screens passed as children,
...
class OnboardSwiper extends React.Component {
  ...
  onComplete = () => {
    if (this.props && this.props.onCompleteCallback) {
    ...
    return (
      ...
      >
        {lastScreen ? (
          ...
          <Button text="Start Now" onPress={() => this.onComplete()} />
        ) : (
